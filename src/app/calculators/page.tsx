...
const allCalculators: Calculator[] = [
  ...
  {
    name: "Crew Day Cost Calculator",
    href: "/calculators/crew-day-cost/",
    description: "Calculate the true daily cost of putting your crew on a job — burdened labor, vehicle, fuel, tools, and overhead allocation.",
    icon: "👷",
    category: "Business",
    tags: ["crew", "day rate", "burdened labor", "labor burden", "workers comp", "payroll tax", "bidding", "true cost"],
  },
  {
    name: "Max Lead Cost Calculator",
    href: "/calculators/lead-cost/",
    description: "Find the most you can afford to pay per lead based on close rate, average job profit, and marketing budget. Compare against HomeAdvisor, Angi, Google LSA pricing.",
    icon: "🎯",
    category: "Business",
    tags: ["lead cost", "CAC", "customer acquisition", "marketing", "homeadvisor", "angi", "google lsa", "thumbtack"],
  },
  {
    name: "W-2 vs 1099 Employee Cost",
    href: "/calculators/employee-true-cost/",
    description: "Calculate the true loaded cost of a W-2 employee vs a 1099 sub. Includes payroll tax, workers comp, benefits, PTO, training, and recruiting.",
    icon: "🧾",
    category: "Business",
