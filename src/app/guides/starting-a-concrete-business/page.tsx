  ...
  return (
    ...
    >
      ...
      <AffiliateProviderCards
        category="insurance"
        heading="Where Concrete Contractors Get Insurance Quotes"
        intro="Concrete carries structural liability that can follow you for years (cracking, settling, finishing defects). Get quotes from at least two carriers before binding a policy."
      />
      ...
      <AffiliateProviderCards
        category="llc"
        heading="LLC Formation Services for Concrete Contractors"
