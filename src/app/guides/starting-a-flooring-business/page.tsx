    ...
    >
      ...
      <div className="bg-orange-50 border border-brand-orange rounded-xl p-6 my-8">
        <h3 className="text-xl font-bold text-brand-blue mb-2">
          Are You a Homeowner Looking for a Flooring Installer?
        </h3>
        <p className="text-gray-700 mb-4">
          If you landed on this page looking for flooring help for your
          home, we can connect you with licensed flooring contractors in
        ...
        >
          Get Free Flooring Quotes at GetContractorQuotes.com
        </a>
      </div>
